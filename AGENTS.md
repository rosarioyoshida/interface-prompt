...
- TypeScript 5.x, Next.js 15.2.1, React 19 + Next.js App Router, React hooks, Tailwind CSS, Shadcn/UI (`DropdownMenu`, `Accordion` quando aplicavel, `Dialog`), `lucide-react` (001-sidebar-search-accordion)
...
## Recent Changes
- 001-sidebar-search-accordion: Added TypeScript 5.x, Next.js 15.2.1, React 19 + Next.js App Router, React hooks, Tailwind CSS, Shadcn/UI (`DropdownMenu`, `Accordion` quando aplicavel, `Dialog`), `lucide-react`
